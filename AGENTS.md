# Family Manager: instructions for AI coding assistants

This file is read by AI coding assistants (Codex, Cursor, GitHub Copilot, Gemini CLI, Claude Code and
others) when someone opens this folder. Most people open it to say
